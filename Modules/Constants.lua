...
Constants.TIMER_INTERVALS = {
    ...
    SCAN_DEBOUNCE = 0.05, -- 50ms debounce window for consecutive OnUpdateStop events
    BANK_CLOSE_TIMEOUT = 3, -- seconds to wait for BAG_UPDATE_DELAYED after bank closes
