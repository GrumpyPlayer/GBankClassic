...
Globals.GetContainerItemID = C_Container.GetContainerItemID or GetContainerItemID
Globals.GetContainerItemInfo = GetContainerItemInfo or C_Container.GetContainerItemInfo
Globals.GetContainerItemLink = C_Container.GetContainerItemLink or GetContainerItemLink
...
Globals.Item = Item
Globals.MailEditBox = MailEditBox
Globals.MailFrame = MailFrame
Globals.MailFrameTab2 = MailFrameTab2
Globals.SendMailNameEditBox = SendMailNameEditBox
Globals.SendMailSubjectEditBox = SendMailSubjectEditBox
Globals.Settings = Settings
Globals.StaticPopupDialogs = StaticPopupDialogs
